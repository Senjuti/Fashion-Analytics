...
/**
 * Fetches posts relating to Forever21 from across different social channels like
...
public class Forever21 extends TimerTask{
	...
	public Forever21(long delay,long period) { 
	...
	public void executeAllChannels() { 
		...
		try { 
			...
			facebook = new FacebookFetch("Forever21");
			facebook.start(); 
			
			tweet_1 = new TweetFetch("@Forever21", "Forever21");
			tweet_2 = new TweetFetch("#Forever21 ", "Forever21");
			tweet_3 = new TweetFetch("Forever21 :)", "Forever21"); 
			tweet_4 = new TweetFetch("forever21 :(", "Forever21"); 
	...
	public static void main(String args[]) { 
		...
		t.scheduleAtFixedRate(new Forever21(), 1000, 5*1000);
	}
}

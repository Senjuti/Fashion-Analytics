...
public class Levis extends TimerTask {
	...
	public Levis(long delay,long period) { 
	...
	public void executeAllChannels() { 
		...
		try { 
			...
			facebook = new FacebookFetch("Levis");
			facebook.start(); 
			
			tweet_1 = new TweetFetch("@levis", "Levis");
			tweet_2 = new TweetFetch("#levis", "Levis");
			tweet_3 = new TweetFetch("levis :)", "Levis"); 
			tweet_4 = new TweetFetch("levis :(", "Levis"); 
	...
	public static void main(String args[]) { 
		...
		t.scheduleAtFixedRate(new Levis(), 1000, 5*1000);
	}
}
